...
__all__ = [
    'OLE_XSIZE_CONTAINER', 'Unchecked', 'Checked',
    'OLE_ENABLEDEFAULTBOOL', 'IFontDisp', 'OLE_XPOS_PIXELS', 'IFont',
    'FONTUNDERSCORE', 'OLE_OPTEXCLUSIVE', 'OLE_XSIZE_HIMETRIC',
    'StdFont', 'OLE_YPOS_CONTAINER', 'OLE_YSIZE_CONTAINER',
    'StdPicture', 'OLE_XSIZE_PIXELS', 'FONTBOLD', 'OLE_YPOS_PIXELS',
    'Gray', 'OLE_XPOS_CONTAINER', 'FONTITALIC', 'IPictureDisp',
    'Color', 'LoadPictureConstants', 'IPicture', 'OLE_YSIZE_PIXELS',
    'OLE_CANCELBOOL', 'FontEvents', 'FONTNAME', 'Font',
    'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC', 'Monochrome', 'Default',
    'OLE_XPOS_HIMETRIC', 'FONTSIZE', 'OLE_HANDLE', 'Picture',
    'VgaColor', 'FONTSTRIKETHROUGH', 'OLE_COLOR',
    'OLE_YSIZE_HIMETRIC', 'IFontEventsDisp'
]

_check_version('1.2.0', 1536996502.167130)
