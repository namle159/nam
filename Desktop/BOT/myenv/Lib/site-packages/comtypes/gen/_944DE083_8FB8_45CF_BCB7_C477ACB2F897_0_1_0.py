...
__all__ = [
    'IUIAutomationTablePattern', 'IUIAutomation4',
    'IUIAutomationPropertyCondition',
    'IUIAutomationItemContainerPattern', 'UIA_ScrollBarControlTypeId',
    'StyleId_Normal', 'UIA_WindowCanMinimizePropertyId',
    'UIA_IsScrollPatternAvailablePropertyId', 'StyleId_Subtitle',
    'UIA_FlowsFromPropertyId', 'UIA_TreeItemControlTypeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'IUIAutomationRangeValuePattern', 'UIA_Drag_DragCompleteEventId',
    'UIA_LegacyIAccessibleStatePropertyId', 'UIA_SummaryChangeId',
    'UIA_RadioButtonControlTypeId', 'UIA_PositionInSetPropertyId',
    'StyleId_BulletedList', 'UIA_OutlineColorPropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_SelectionPatternId', 'IUIAutomation3',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_LinkAttributeId', 'TreeTraversalOptions_PostOrder',
    'UIA_StructureChangedEventId',
    'UIA_Selection2FirstSelectedItemPropertyId', 'StyleId_Heading3',
    'AnnotationType_MoveChange', 'AnnotationType_FormatChange',
    'UIA_TransformCanResizePropertyId', 'ScrollAmount_LargeIncrement',
    'UIA_AppBarControlTypeId', 'TreeScope_Descendants',
    'OrientationType_Horizontal', 'AnnotationType_DeletionChange',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'IUIAutomationProxyFactory',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'IUIAutomationDropTargetPattern', 'UIA_SpreadsheetPatternId',
    'UIA_AnnotationTypesPropertyId', 'AutomationElementMode_Full',
    ...
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationTextEditPattern',
    'PropertyConditionFlags_None', 'ToggleState_Indeterminate',
    'UIA_InputReachedTargetEventId', 'UIA_CenterPointPropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_AnnotationAuthorPropertyId',
    'UIA_LegacyIAccessibleRolePropertyId', 'AnnotationType_Footnote',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_IsItalicAttributeId',
    'IUIAutomationSpreadsheetPattern', 'NavigateDirection_FirstChild',
    'UIA_BulletStyleAttributeId',
    'AnnotationType_AdvancedProofingIssue',
    'SynchronizedInputType_KeyDown', 'HeadingLevel1',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_AnimationStyleAttributeId', 'TreeTraversalOptions',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_StylesFillPatternStylePropertyId', 'IAccessible',
    'UIA_ToolTipOpenedEventId', 'UIA_OverlineStyleAttributeId',
    'OrientationType_Vertical', 'UIA_ProviderDescriptionPropertyId',
    'UIA_VirtualizedItemPatternId', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_BoundingRectanglePropertyId', 'WindowVisualState_Normal',
    'UIA_TreeControlTypeId', 'IUIAutomationElement9',
    'UIA_ValueIsReadOnlyPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_RangeValueValuePropertyId', 'UIA_SystemAlertEventId',
    'UIA_ControlTypePropertyId', 'UIA_AcceleratorKeyPropertyId',
    'HeadingLevel_None', 'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_TextEdit_TextChangedEventId', 'AnnotationType_Footer',
    'UIA_ProgressBarControlTypeId', 'IUIAutomationElementArray',
    'ProviderOptions_UseComThreading', 'HeadingLevel5',
    'UIA_ToolBarControlTypeId', 'UIA_PaneControlTypeId',
    'IUIAutomationTextPattern2',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_DropTarget_DragEnterEventId', 'UIA_StylesShapePropertyId',
    'IUIAutomationTransformPattern', 'UIA_MenuModeStartEventId',
    ...
    'UIA_ValueValuePropertyId', 'SynchronizedInputType_RightMouseUp',
    'IUIAutomation6', 'UIA_IsObjectModelPatternAvailablePropertyId',
    'TextEditChangeType_Composition', 'CUIAutomation8',
    'UIA_HyperlinkControlTypeId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_ScrollVerticalViewSizePropertyId', 'UIA_WindowControlTypeId',
    'RowOrColumnMajor', 'UIA_LegacyIAccessiblePatternId',
    'IUIAutomationWindowPattern', 'UIA_HeadingLevelPropertyId',
    'HeadingLevel3', 'ProviderOptions_OverrideProvider',
    'TreeScope_Children', 'StyleId_Heading7', 'UIA_ScrollPatternId',
    'ScrollAmount_SmallDecrement',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'RowOrColumnMajor_RowMajor',
    'UIA_IndentationFirstLineAttributeId', 'StyleId_Heading2',
    'UIA_SearchLandmarkTypeId', 'UIA_LiveSettingPropertyId',
    'UIA_AnnotationPatternId', 'UIA_SelectionItemPatternId',
    'TextPatternRangeEndpoint_Start',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_CalendarControlTypeId',
    'IUIAutomationNotificationEventHandler',
    'UIA_AutomationFocusChangedEventId', 'UIA_Drag_DragStartEventId',
    'TextUnit_Word', 'UIA_SayAsInterpretAsAttributeId',
    'CoalesceEventsOptions_Disabled', 'ZoomUnit',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'OrientationType', 'UIA_IsTransformPattern2AvailablePropertyId',
    'IUIAutomationTextRange2',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'IUIAutomationOrCondition', 'ToggleState', 'DockPosition_Fill',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_CaretPositionAttributeId',
    'UIA_IsDialogPropertyId', 'UIA_CustomControlTypeId',
    'UIA_TextPattern2Id', 'UIA_BeforeParagraphSpacingAttributeId',
    'TreeTraversalOptions_Default', 'DockPosition_Right',
    'StyleId_Heading4',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'WindowInteractionState', 'IUIAutomation2',
    'UIA_RangeValueSmallChangePropertyId', 'SynchronizedInputType',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_SeparatorControlTypeId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'HeadingLevel8',
    'UIA_ValuePatternId', 'StyleId_Heading1',
    'IUIAutomationEventHandler', 'ScrollAmount_SmallIncrement',
    'UIA_TransformPattern2Id', 'UIA_IsSuperscriptAttributeId',
    'ProviderOptions_ProviderOwnsSetFocus', 'UIA_MainLandmarkTypeId',
    'UIA_DropTargetPatternId', 'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_IsContentElementPropertyId', 'StyleId_Heading9',
    'TextUnit_Page', 'UIA_RangeValueMinimumPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_WindowIsTopmostPropertyId', 'IUIAutomationSelectionPattern',
    'UIA_FlowsToPropertyId', 'DockPosition_Bottom',
    'UIA_FillColorPropertyId', 'IUIAutomationProxyFactoryMapping',
    'ZoomUnit_SmallIncrement', 'UIA_MenuModeEndEventId',
    'IUIAutomationElement7', 'IUIAutomationBoolCondition',
    'IUIAutomationElement5', 'UIA_StrikethroughColorAttributeId',
    'ConnectionRecoveryBehaviorOptions',
    'IUIAutomationChangesEventHandler', 'UIA_ClassNamePropertyId',
    ...
    'NotificationProcessing_ImportantAll', 'TextUnit_Line',
    'AnnotationType_SpellingError',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_ExpandCollapsePatternId',
    'UIA_TableRowHeadersPropertyId', 'UIA_LabeledByPropertyId',
    'UIA_StylesStyleIdPropertyId', 'UIA_DockPatternId',
    'UIA_DropTargetDropTargetEffectPropertyId', 'StyleId_Title',
    'UIA_TextChildPatternId', 'IUIAutomationDragPattern',
    'AnnotationType_Comment', 'UIA_Window_WindowClosedEventId',
    'IUIAutomationElement', 'UIA_SelectionSelectionPropertyId',
    'UIA_EditControlTypeId', 'IUIAutomationTextRange',
    'UIA_Transform2CanZoomPropertyId',
    'NavigateDirection_NextSibling', 'UIA_HeaderControlTypeId',
    'IUIAutomationTransformPattern2',
    'IUIAutomationEventHandlerGroup',
    'UIA_SelectionActiveEndAttributeId', 'TreeScope_None',
    'DockPosition', 'UIA_IsPeripheralPropertyId',
    'ZoomUnit_LargeDecrement',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_GridItemColumnPropertyId', 'ToggleState_Off',
    'IUIAutomationDockPattern',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_FontWeightAttributeId', 'TextUnit_Format',
    'NotificationKind', 'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_FullDescriptionPropertyId',
    'StructureChangeType_ChildrenReordered',
    'UIA_LineSpacingAttributeId', 'UIA_StatusBarControlTypeId',
    'UIA_GridItemRowPropertyId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_Window_WindowOpenedEventId', 'UIA_MarginTrailingAttributeId',
    'UIA_ListItemControlTypeId', 'UIA_DockDockPositionPropertyId',
    'AutomationElementMode', 'UIA_TitleBarControlTypeId',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_FrameworkIdPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'IUIAutomationTreeWalker', 'UIA_LandmarkTypePropertyId',
    'IUIAutomationGridPattern',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'IUIAutomationGridItemPattern', 'StyleId_Heading5',
    'ZoomUnit_SmallDecrement', 'UIA_SynchronizedInputPatternId',
    'IUIAutomationProxyFactoryEntry', 'UIA_OutlineStylesAttributeId',
    'UIA_HelpTextPropertyId', 'IUIAutomationElement2',
    'WindowInteractionState_Running',
    'UIA_TransformCanRotatePropertyId', 'UIA_CultureAttributeId',
    'UIA_AnnotationDateTimePropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'NotificationKind_ActionAborted', 'ExpandCollapseState_Expanded',
    'AnnotationType_Unknown', 'IUIAutomationElement4',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'AnnotationType_TrackChanges', 'PropertyConditionFlags',
    'UIA_WindowPatternId', 'UIA_ControllerForPropertyId',
    'AnnotationType_Endnote', 'UIA_IsGridPatternAvailablePropertyId',
    'UIA_LocalizedLandmarkTypePropertyId', 'UIA_AccessKeyPropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_ToolTipClosedEventId',
    'Off', 'UIA_MenuOpenedEventId', 'IUIAutomationElement8',
    'AnnotationType_Header', 'AnnotationType_FormulaError',
    'IUIAutomationTextChildPattern', 'UIA_ComboBoxControlTypeId',
    'UIA_StyleNameAttributeId', 'UIA_InvokePatternId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_SplitButtonControlTypeId',
    'UIA_Selection2ItemCountPropertyId', 'TreeScope_Parent',
    'UIA_CaretBidiModeAttributeId',
    'AnnotationType_ConflictingChange', 'UIA_OrientationPropertyId',
    'UIA_AriaRolePropertyId', 'NotificationKind_ActionCompleted',
    'TextUnit_Document', 'UIA_DataItemControlTypeId', 'HeadingLevel4',
    ...
    'NotificationProcessing', 'IUIAutomationSelectionPattern2',
    'SupportedTextSelection_Multiple',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'ScrollAmount_LargeDecrement', 'UIA_MultipleViewPatternId',
    'UIA_OutlineThicknessPropertyId', 'UIA_ClickablePointPropertyId',
    'UIA_DescribedByPropertyId', 'UIA_StyleIdAttributeId',
    'UIA_Transform2ZoomLevelPropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'NavigateDirection_PreviousSibling', 'Assertive',
    'UIA_TransformCanMovePropertyId', 'UIA_TableItemPatternId',
    'IUIAutomationAnnotationPattern', 'IUIAutomationTextRangeArray',
    'IRawElementProviderSimple', 'TextPatternRangeEndpoint_End',
    'UIA_CheckBoxControlTypeId',
    'UIA_Transform2ZoomMinimumPropertyId',
    'NotificationKind_ItemRemoved', 'AnnotationType_Highlighted',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_NamePropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_HeaderItemControlTypeId',
    'StyleId_Quote', 'UIA_RangeValuePatternId',
    'UIA_IsPasswordPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_ForegroundColorAttributeId', 'UIA_DragDropEffectPropertyId',
    'PropertyConditionFlags_MatchSubstring',
    'WindowInteractionState_NotResponding',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_MarginTopAttributeId', 'StyleId_Emphasis',
    'UIA_CustomLandmarkTypeId', 'UIA_GridItemPatternId',
    'WindowVisualState_Maximized', 'UIA_IsHiddenAttributeId',
    'AnnotationType_DataValidationError',
    'UIA_ToggleToggleStatePropertyId', 'StyleId_Heading6',
    'StructureChangeType_ChildRemoved',
    'IUIAutomationFocusChangedEventHandler',
    'SupportedTextSelection_Single', 'Polite',
    'UIA_MenuClosedEventId', 'NotificationKind_ItemAdded',
    'IUIAutomationPropertyChangedEventHandler', 'IUIAutomation',
    'HeadingLevel2', 'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'ProviderOptions_UseClientCoordinates',
    'RowOrColumnMajor_Indeterminate', 'NotificationKind_Other',
    'UIA_ButtonControlTypeId',
    'ProviderOptions_NonClientAreaProvider',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_IsRequiredForFormPropertyId', 'UIA_StylesPatternId',
    'UIA_FontSizeAttributeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_TransformPatternId', 'IUIAutomationCondition',
    'IUIAutomationScrollItemPattern', 'AutomationElementMode_None',
    'UIA_DragIsGrabbedPropertyId', 'UIA_SliderControlTypeId',
    'WindowVisualState', 'UIA_IsEnabledPropertyId',
    'UIA_TextControlTypeId', 'UIA_GridColumnCountPropertyId',
    'UIA_AnnotationObjectsPropertyId', 'TextUnit_Paragraph',
    'ExpandCollapseState_Collapsed',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'SynchronizedInputType_KeyUp',
    'UIA_IsKeyboardFocusablePropertyId', 'AnnotationType_Mathematics',
    ...
    'IUIAutomationValuePattern', 'UIA_SpreadsheetItemPatternId',
    'UIA_WindowWindowVisualStatePropertyId', 'DockPosition_Top',
    'IUIAutomationElement3', 'UIA_GridRowCountPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'IUIAutomationInvokePattern', 'StyleId_NumberedList',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'NavigateDirection_LastChild',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_MarginLeadingAttributeId',
    'ProviderOptions_ServerSideProvider',
    'TextEditChangeType_AutoComplete', 'UIA_AutomationIdPropertyId',
    'UIA_TabsAttributeId', 'UIA_ItemContainerPatternId',
    'UIA_MultipleViewCurrentViewPropertyId', 'IUIAutomationElement6',
    'WindowInteractionState_BlockedByModalWindow',
    'AnnotationType_InsertionChange', 'IUIAutomationTextPattern',
    'UIA_Invoke_InvokedEventId', 'TreeScope_Subtree',
    'ExpandCollapseState', 'UIA_ToolTipControlTypeId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_ItemStatusPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'StructureChangeType', 'IUIAutomationAndCondition',
    'UIA_ThumbControlTypeId', 'TextEditChangeType_AutoCorrect',
    ...
    'UIA_IsSelectionPattern2AvailablePropertyId', 'StyleId_Heading8',
    'UIA_CulturePropertyId', 'UIA_SpinnerControlTypeId',
    'UIA_LocalizedControlTypePropertyId', 'TextEditChangeType',
    'TextUnit', 'UIA_SizePropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_AriaPropertiesPropertyId', 'CUIAutomation',
    ...
    'IUIAutomationScrollPattern', 'UIA_MenuControlTypeId',
    'AnnotationType_GrammarError', 'ExpandCollapseState_LeafNode',
    'UIA_StylesStyleNamePropertyId', 'UIA_DragPatternId',
    'UIA_ListControlTypeId', 'UIA_SizeOfSetPropertyId',
    'UIA_ImageControlTypeId', 'UIA_ScrollItemPatternId',
    'TextEditChangeType_None', 'UIA_IsDataValidForFormPropertyId',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomation5', 'UIA_RotationPropertyId',
    'UIA_StrikethroughStyleAttributeId', 'UIA_DataGridControlTypeId',
    'IUIAutomationMultipleViewPattern', 'UIA_TogglePatternId',
    'LiveSetting', 'IUIAutomationVirtualizedItemPattern',
    'UIA_AsyncContentLoadedEventId', 'UIA_StylesFillColorPropertyId',
    'UIA_IsSubscriptAttributeId', 'WindowInteractionState_Closing',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'IUIAutomationObjectModelPattern', 'IUIAutomationNotCondition',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_IsActiveAttributeId', 'UIA_LevelPropertyId',
    'UIA_RangeValueMaximumPropertyId',
    'NotificationProcessing_CurrentThenMostRecent', 'UiaChangeInfo',
    'UIA_InputDiscardedEventId', 'UIA_CustomNavigationPatternId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_AnnotationTargetPropertyId', 'TreeScope_Ancestors',
    'UIA_TablePatternId', 'UIA_FormLandmarkTypeId',
    'NavigateDirection_Parent', 'IUIAutomationTableItemPattern',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'AnnotationType_EditingLockedChange',
    'UIA_AnnotationTypesAttributeId', 'ZoomUnit_NoAmount',
    'NotificationProcessing_All', 'UIA_Text_TextChangedEventId',
    'IUIAutomationTogglePattern',
    'UIA_RangeValueLargeChangePropertyId', 'StyleId_Custom',
    'UIA_DocumentControlTypeId', 'ScrollAmount_NoAmount',
    'ProviderOptions_ClientSideProvider',
    'IUIAutomationSelectionItemPattern',
    'UIA_AnnotationObjectsAttributeId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_IsReadOnlyAttributeId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_SelectionPattern2Id', 'UIA_GridItemRowSpanPropertyId',
    'SupportedTextSelection_None', 'UIA_TextPatternId',
    'HeadingLevel9', 'DockPosition_Left',
    'UIA_OverlineColorAttributeId', 'UIA_BackgroundColorAttributeId',
    ...
    'UIA_RuntimeIdPropertyId', 'UIA_GridItemContainingGridPropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'IUIAutomationStylesPattern', 'TextPatternRangeEndpoint',
    'AnnotationType_ExternalChange', 'DockPosition_None',
    'UIA_Drag_DragCancelEventId', 'UIA_DropTarget_DragLeaveEventId',
    'StructureChangeType_ChildAdded', 'UIA_GridPatternId',
    'UIA_SpreadsheetItemFormulaPropertyId', 'HeadingLevel7',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_IsTextPattern2AvailablePropertyId', 'TextUnit_Character',
    'TreeScope', 'AnnotationType_Author',
    'UIA_IsControlElementPropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'ExtendedProperty',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_IsOffscreenPropertyId', 'ProviderOptions',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'TreeTraversalOptions_LastToFirstOrder', 'SupportedTextSelection',
    'TreeScope_Element', 'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_InputReachedOtherElementEventId', 'UIA_ObjectModelPatternId',
    'ToggleState_On', 'UIA_MenuBarControlTypeId',
    'UIA_FillTypePropertyId', 'OrientationType_None',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'IUIAutomationTextRange3', 'UIA_ChangesEventId',
    'CoalesceEventsOptions', 'UIA_VisualEffectsPropertyId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_SemanticZoomControlTypeId', 'ScrollAmount',
    'UIA_NotificationEventId', 'UIA_WindowIsModalPropertyId',
    'UIA_FontNameAttributeId',
    'ProviderOptions_RefuseNonClientSupport'
]

_check_version('1.2.0', 1536996510.794215)
